...
echo "{ \
  ...
  \"accounts\": { \
    ...
    \"efadf166849f06eee4b44ddb78e4162580f436b1\": { \"balance\": \"1000000000000000000000\", \"storage\": {}, \"nonce\": \"0x0\", \"code\": \"\"}, \
    \"0000000000000000000000000000000000000420\": { \"code\": \"0x`cat blake2b.wasm | xxd -p -c 100000`\", \"balance\": \"0x01\", \"nonce\": \"0x0\", \"storage\": {}} \
  } \
}"
