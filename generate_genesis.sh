...
echo "{ \
  ...
  \"accounts\": { \
    ...
    \"efadf166849f06eee4b44ddb78e4162580f436b1\": { \"balance\": 10000000000}, \
    \"0000000000000000000000000000000000000420\": { \"code\": \"`cat blake2b.wasm | xxd -p -c 100000`\", \"balance\": \"0x01\" } \
  } \
}"
